...
<body>
    ...
    <div class="admin-container">
        <div class="admin-header">
            ...
            <p>Danh sách tất cả các tin nhắn liên hệ từ khách hàng</p>
        </div>
            ...
            <table id="contactTable">
                ...
                <tbody>
                    <?php if (empty($danhsach)): ?>
                        <tr>
                            <td colspan="8" style="text-align: center; padding: 20px;">Chưa có tin nhắn liên hệ nào</td>
                        </tr>
                    <?php else: ?>
                        <?php foreach ($danhsach as $item): ?>
                            <tr>
                                ...
                                <td>
                                    <?php 
                                    $statusClass = $item['TRANGTHAI'] == 'Chưa xử lý' ? 'status-new' : 'status-replied';
                                    ?>
                                ...
                                <td>
                                    ...
                                    <button class="action-btn btn-reply" onclick="replyContact(<?= $item['ID'] ?>)">Phản hồi</button>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php endif; ?>
    ...
    <script>
        ...
        function viewDetail(id) {
            window.location.href = 'chi_tiet_lienhe.php?id=' + id;
        }
        
        function replyContact(id) {
            window.location.href = 'phan_hoi_lienhe.php?id=' + id;
        }
    </script>
</body>
</html>
